...
do
	...
	/user4/kyoto1/hiroakif/fastp --detect_adapter_for_pe -l 50 -q 20 -n 0 -w 16 -3 -W 6 -M 20 -i ${fa}/${fwd} -I ${fa}/${rvs} -o ${out2}/${i}_R1.fastq.gz -O ${out2}/${i}_R2.fastq.gz -h ${out2}/report_${i}.html
